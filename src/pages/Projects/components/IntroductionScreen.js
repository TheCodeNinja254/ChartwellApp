...
import introImage from "../../../assets/images/Graphics/project.jpg";
            ...
            <Grid item lg={6} xl={6} md={6} sm={12} xs={12}>
              <span className={classes.IntroText}>
                <span>
                  ...
                  <Typography className={classes.descriptionText}>
                    Organize projects around delivery of value and realization
                    of opportunities for large scale and timed improvement.
                  </Typography>
                </span>
              </span>
            </Grid>
